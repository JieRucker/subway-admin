...
const webpackConfig = merge(baseWebpackConfig, {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      filename: config.build.vmRoot + '/subway/manager.vm',
      inject: false,
      minify: {
        removeComments: true,
    ...
    new HtmlWebpackPlugin({
      ...
      iconfont: '//at.alicdn.com/t/font_458067_txd3eb7dw1giudi.css?v=' + new Date().getTime(),
      jquery: staticUrl + 'static/js/jquery.min.js',
      jmessage:staticUrl + 'static/js/jmessage.min.js',
      template: '!!ejs-loader!./src/template/tv.ejs',
      filename: config.build.vmRoot + '/subway/tv.vm',
      inject: false,
      minify: {
        removeComments: true,
        collapseWhitespace: true,
    ...
    new CopyWebpackPlugin((() => {
        ...
        const copyPath = {
          ...
          '../src/libs/jmessage/jmessage.min.js': 'static/js',
